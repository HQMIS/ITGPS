...
<html>
	...
	<body class="impress-not-supported" style="cursor: url(Wait.ani);">
		<div id="wrap">
			...
			<div id="impress">
				<div id="python" class="step slide" data-x="0"
					...
					<div class="container-fluid">
						...
						<div class="row-fluid">
							...
							<div class="span3" class="text-center">
								<p class="text-center">
									<a href="http://python.cn/" target=_blank><img id="imgstyle"
											src="<%=path%>/logo/CPyUG.png"
						...
						<div class="row-fluid">
							<div class="span3">
								<p class="text-center">
									<a href="http://www.crummy.com/software/BeautifulSoup/" target=_blank><img
											id="imgstyle" src="<%=path%>/logo/BeautifulSoup.png"
							...
							<div class="span3" class="text-center">
								<p class="text-center">
									<a href="http://docs.python-requests.org/en/latest/" target=_blank><img
											id="imgstyle" src="<%=path%>/logo/requests.png"
							...
							<div class="span3" class="text-center">
								<p class="text-center">
									<a href="http://pandas.pydata.org/" target=_blank><img id="imgstyle"
											src="<%=path%>/logo/pandas.png"
							...
							<div class="span3">
								<p class="text-center">
									<a href="http://www.scipy.org/" target=_blank><img
											...
											title="SciPy (pronounced "Sigh Pie") is open-source software for mathematics, science, and engineering. It is also the name of a very popular conference on scientific programming with Python. The SciPy library depends on NumPy, which provides convenient and fast N-dimensional array manipulation. ">
									</a>
								</p>
							</div>
						</div>
						...
						<div class="span3">
							<p class="text-center">
								<a href="http://learnyouahaskell-zh-tw.csie.org/" target=_blank><img
										...
										title="Learn you a Haskell for Great Good 中文版">
								</a>
							</p>
						</div>
						<div class="span3" class="text-center">
