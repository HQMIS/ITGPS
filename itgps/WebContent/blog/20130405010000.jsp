				...
				<div class="row-fluid">
					...
					<div class="span6" class="text-center">
						<ul>
							...
							<p class="content_fontset">
								&nbsp&nbsp&nbsp&nbsp 1. 打开
								<a href="http://www.rubyinstaller.org/downloads/"
									target="_blank">http://www.rubyinstaller.org/downloads/</a>下载最新的Ruby版本，直接安装，安装过程中请选择加入到系统的path路径中。
								<br>
								&nbsp&nbsp&nbsp&nbsp 2. 开始==》所有程序==》Ruby 2.0.0-p0==》Start
