		...
		<div id="wrap">
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span3">
						<p class="text-center">
							<a href="http://jquery.com/" target=_blank><img id="imgstyle"
									src="<%=path%>/logo/jQuery.png"
					...
					<div class="span3" class="text-center">
						<p class="text-center">
							<a href="http://nodejs.org/" target=_blank><img id="imgstyle"
									src="<%=path%>/logo/node.js.png"
